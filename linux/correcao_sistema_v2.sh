...
# Isso nos ajuda a medir o quanto foi liberado ao final do processo
...
# 7. Desativar o GNOME Tracker de forma compatível com a versão do Ubuntu
# Detecta se está usando o Tracker moderno (tracker3) ou antigo (tracker)
# Aplica o reset ou desativa monitoramento de arquivos conforme o ambiente
...
# Mostra o espaço em disco após a limpeza
